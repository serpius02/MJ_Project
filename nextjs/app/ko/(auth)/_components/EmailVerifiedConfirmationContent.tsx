// app/ko/(auth)/_components/EmailVerifiedContent.tsx
...
export default function EmailVerifiedConfirmationContent() {
    ...
    <main className="w-full min-h-screen flex justify-center items-center p-4">
      ...
      >
        ...
        <div className="relative z-20 mx-auto p-4 pb-12 sm:p-6 sm:pb-16 md:p-8 md:pb-20">
          ...
          <Button
            type="button"
            className="mt-2 rounded-md max-w-[300px] h-12 px-12 py-3 text-sm text-primary-foreground font-medium"
